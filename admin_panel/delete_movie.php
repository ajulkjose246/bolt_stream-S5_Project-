            ...
            <div class="container sub_body">
                <div class="disp_mov my-5">
                    ...
                    <table class="table table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a class="btn btn-danger" href="../admin_panel/delete_movie_data.php?id=<?= $display_movie_row['mov_id'] ?>">Delete</a></td>
                            </tr>
                        <?php }
                    ...
                    <div class="my-5" style="text-align:center;">
                        ...
                        <a href="../admin_panel/delete_movie.php" name="reset_btn" class="btn btn-primary">Reset</a>
                    </div>
                </div>
