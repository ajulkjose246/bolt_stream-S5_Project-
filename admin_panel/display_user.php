            ...
            <div class="container sub_body">
                <div class="disp_mov my-5">
                    ...
                    <table class="table table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a class="btn btn-primary" href="../pro_pic/<?= $display_user_row['usr_pic'] ?>" target="_blank">Load</a></td>
                               </tr>
                        <?php
                         }
                        ?>
                    ...
                    <div class="my-5" style="text-align:center;">
                        ...
                        <a href="../admin_panel/display_user.php" name="reset_btn" class="btn btn-primary">Reset</a>
                    </div>
                </div>
